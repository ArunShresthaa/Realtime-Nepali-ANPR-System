<ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center bg-gradient-light  justify-content-center" href="index.php">
        <div class="sidebar-brand-icon">
            <img src="../img/logo/attnlg.png">
        </div>
        <div class="sidebar-brand-text mx-3" style="color: black;">ANPR System</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="createRecords.php">Create Records</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="manageCamera.php">Manage Cameras</a>
                <a class="collapse-item" href="manageReason.php">Manage Reasons</a>
