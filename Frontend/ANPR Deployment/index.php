...
<body class="bg-gradient-login" style="background-image: url('img/logo/loral1.jpe00g');">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <h5 align="center">ANPR SYSTEM</h5>
  ...
  if(isset($_POST['login'])){
    ...
    $query = "SELECT users.Id,users.role,users.firstName,users.lastName,users.email FROM credentials INNER JOIN users ON credentials.userID = users.Id WHERE users.email = '$username' AND credentials.password = '$password'";
    $rs = $conn->query($query);
    $num = $rs->num_rows;
